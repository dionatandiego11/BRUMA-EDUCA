      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-emerald-600 p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">EDUCA-BRUMA</h1>
              <p className="text-blue-100 text-sm">Sistema de Gestão de Provas</p>
            </div>
          </div>
        </div>
        ...
        <div className="relative z-10 space-y-6">
          <div className="bg-white bg-opacity-10 backdrop-blur-sm p-6 rounded-2xl border border-white border-opacity-20">
            ...
            <p className="text-blue-50 text-sm">
              Gerencie provas e avaliações da Secretaria de Educação de Brumadinho de forma simples e segura.
            </p>
          </div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="lg:hidden flex items-center justify-center gap-3 mb-8">
            ...
            <div>
              <h1 className="text-2xl font-bold text-gray-800">EDUCA-BRUMA</h1>
              <p className="text-gray-500 text-sm">Sistema de Gestão de Provas</p>
            </div>
          </div>
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      type="email"
                      placeholder="seu.email@educacao.brumadinho.mg.gov.br"
                      value={email}
                ...
                <button 
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-emerald-600 hover:from-blue-700 hover:to-emerald-700 text-white font-semibold py-3 rounded-lg shadow-lg transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
                  disabled={isLoading}
                >
                  {isLoading ? (
